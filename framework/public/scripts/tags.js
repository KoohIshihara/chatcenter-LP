...
riot.tag2('item-what-card', '<div class="wrap-item py30"> <div class="wrap-img mb20 f fh"><img riot-src="{opts.content.src}"></div> <div class="wrap-texts"> <p class="title mb12">{opts.content.title}</p> <p class="position mb12">{opts.content.position}</p> <p class="sentence">{opts.content.text}</p> </div> </div>', 'item-what-card,[data-is="item-what-card"]{display:block;width:30%;background:#ffffff} item-what-card .wrap-item,[data-is="item-what-card"] .wrap-item{width:100%;height:100%} item-what-card .wrap-item .wrap-img img,[data-is="item-what-card"] .wrap-item .wrap-img img{width:60%} item-what-card .wrap-item .wrap-texts,[data-is="item-what-card"] .wrap-item .wrap-texts{width:90%;margin:0 auto} item-what-card .wrap-item .wrap-texts .title,[data-is="item-what-card"] .wrap-item .wrap-texts .title{text-align:center;font-size:14px;color:#2a2a2a} item-what-card .wrap-item .wrap-texts .position,[data-is="item-what-card"] .wrap-item .wrap-texts .position{text-align:center;font-size:14px;color:#999999;font-weight:lighter;line-height:1.4} item-what-card .wrap-item .wrap-texts .sentence,[data-is="item-what-card"] .wrap-item .wrap-texts .sentence{text-align:center;font-size:14px;color:#999999;font-weight:lighter;line-height:1.4}@media only screen and (max-width : 600px){ item-what-card,[data-is="item-what-card"]{width:100%;margin-bottom:14px}}', '', function(opts) {
});
...
riot.tag2('module-why-points', '<div class="wrap-module"> <p class="lead mb24">{content.lead_text}</p> <item-why-points-point each="{item in content.contents}" content="{item}"></item-why-points-point> </div>', 'module-why-points,[data-is="module-why-points"]{display:block;width:100%;background:#f2f2f2} module-why-points .wrap-module,[data-is="module-why-points"] .wrap-module{width:90%;max-width:1048px;margin:0 auto} module-why-points .wrap-module .lead,[data-is="module-why-points"] .wrap-module .lead{text-align:center}', 'class="py40"', function(opts) {
