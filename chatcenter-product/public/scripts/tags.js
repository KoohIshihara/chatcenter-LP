...
riot.tag2('item-button-cta', '<div class="wrap-item py24"><a class="px16 py12" href="{opts.content.href}">{opts.content.label}</a></div>', 'item-button-cta a,[data-is="item-button-cta"] a{display:block;border-radius:34px;background:#EB5757;color:#ffffff;letter-spacing:1.2px;cursor:pointer}', 'if="{opts.content}"', function(opts) {
});
...
riot.tag2('item-why-points-point', '<div class="wrap-item f flex-wrap"> <div class="wrap-img mr12 f fh"><img riot-src="{opts.content.src}"></div> <div class="wrap-text f fh"> <div> <p class="title mb12">{opts.content.title}</p> <p class="text">{opts.content.text}</p> </div> </div> </div>', 'item-why-points-point,[data-is="item-why-points-point"]{display:block;width:100%;border-radius:3px;background:#ffffff} item-why-points-point .wrap-item .wrap-img,[data-is="item-why-points-point"] .wrap-item .wrap-img{width:30%} item-why-points-point .wrap-item .wrap-img img,[data-is="item-why-points-point"] .wrap-item .wrap-img img{width:80%} item-why-points-point .wrap-item .wrap-text,[data-is="item-why-points-point"] .wrap-item .wrap-text{width:65%} item-why-points-point .wrap-item .wrap-text .title,[data-is="item-why-points-point"] .wrap-item .wrap-text .title{font-weight:bold} item-why-points-point .wrap-item .wrap-text .text,[data-is="item-why-points-point"] .wrap-item .wrap-text .text{line-height:1.4}', 'class="px20 py32 mb12"', function(opts) {
});
...
riot.tag2('module-authority-simple-img', '<div class="wrap-module"> <item-h2 if="{opts.content.title}" content="{opts.content.title}"></item-h2> <div class="wrap-img f flex-between flex-wrap"><a each="{card in opts.content.cards}"><img riot-src="{card.src}"></a></div> </div>', 'module-authority-simple-img,[data-is="module-authority-simple-img"]{display:block;width:100%;background:#e0e0e0} module-authority-simple-img .wrap-module,[data-is="module-authority-simple-img"] .wrap-module{width:90%;max-width:1048px;margin:0 auto} module-authority-simple-img .wrap-module .wrap-img a,[data-is="module-authority-simple-img"] .wrap-module .wrap-img a{width:33%}@media only screen and (max-width : 600px){ module-authority-simple-img .wrap-module .wrap-img a,[data-is="module-authority-simple-img"] .wrap-module .wrap-img a{width:49%}}', 'class="py40"', function(opts) {
});
...
riot.tag2('module-price-table', '<div class="wrap-module"> <item-h2 if="{opts.content.title}" content="{opts.content.title}"></item-h2> <div class="wrap-table"> <table> <thead> <th each="{th in opts.content.table.thead}">{th}</th> </thead> <tbody> <tr each="{trs in opts.content.table.trs}"> <td each="{td in trs}"> <p class="text" if="{td.text}">{td.text}</p> <p class="detail" if="{td.detail}">{td.detail}</p> <div class="img f fh"><img if="{td.check}" src="./img/icon/check.svg"></div> </td> </tr> </tbody> </table> </div> </div>', 'module-price-table,[data-is="module-price-table"]{display:block;width:100%;background:#f2f2f2} module-price-table .wrap-module,[data-is="module-price-table"] .wrap-module{width:90%;max-width:1048px;margin:0 auto} module-price-table .wrap-module .wrap-table,[data-is="module-price-table"] .wrap-module .wrap-table{margin:0 auto} module-price-table .wrap-module .wrap-table table,[data-is="module-price-table"] .wrap-module .wrap-table table{width:100%;background:#ffffff;border-radius:3px;overflow:hidden} module-price-table .wrap-module .wrap-table table tr td,[data-is="module-price-table"] .wrap-module .wrap-table table tr td{text-align:center;font-weight:lighter} module-price-table .wrap-module .wrap-table table tr td .text,[data-is="module-price-table"] .wrap-module .wrap-table table tr td .text{font-weight:bold} module-price-table .wrap-module .wrap-table table,[data-is="module-price-table"] .wrap-module .wrap-table table,module-price-table .wrap-module .wrap-table th,[data-is="module-price-table"] .wrap-module .wrap-table th,module-price-table .wrap-module .wrap-table td,[data-is="module-price-table"] .wrap-module .wrap-table td{border-collapse:collapse;border:.5px solid rgba(0,0,0,0.1);line-height:1.5;padding:6px;word-break:break-word}', 'class="py40"', function(opts) {
    this.on('mount', function(){
...
riot.tag2('module-what', '<div class="wrap-module py40"> <item-h2 if="{opts.content.title}" content="{opts.content.title}"></item-h2> <div class="wrap-card f flex-between flex-wrap"> <item-what-card each="{item in opts.content.cards}" content="{item}"></item-what-card> <div style="width: 30%;"></div> </div> <div class="wrap-button f fc"> <item-button-cta content="{opts.content.cta}"></item-button-cta> </div> </div>', 'module-what,[data-is="module-what"]{display:block;width:100%;background:#e0e0e0} module-what .wrap-module,[data-is="module-what"] .wrap-module{width:90%;max-width:1048px;margin:0 auto}', '', function(opts) {
    this.on('mount', function(){
...
riot.tag2('page-top', '<div class="wrap-page"> <module-hiro content="{contents.hiro}"></module-hiro> <module-why-points content="{contents.why_points}"></module-why-points> <module-what content="{contents.what}"></module-what> <module-use-case content="{contents.use_case}"></module-use-case> <module-authority-simple-img content="{contents.authority_simple_img}"></module-authority-simple-img> <module-price-table content="{contents.price}"></module-price-table> <footer></footer> </div> <float-action-button></float-action-button>', 'page-top .wrap-page,[data-is="page-top"] .wrap-page{display:block;width:100%;height:100%;background:#FFFFFF}', '', function(opts) {
    var self = this;
